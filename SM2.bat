...
for %%z in ( 34 35 ) do (
	...
	if %%z equ 29 (
		...
		set interval2=61 1 62
	)
	REM ende
	
	REM anfang 32 - 289415 - S-974 / s979 Schildschwanz
	if %%z equ 32 (
		REM goto :takeTime
	...
	REM anfang 33 - 289415 - S-974 / s979 Schildschwanz -ve
	if %%z equ 33 (
		REM goto :takeTime
		set proj_Num=289415a
		set interval=1119 10 1199
	...
	REM anfang 34 - 289415 - S-974 / s979 Schildschwanz
	if %%z equ 34 (
		REM goto :takeTime
	...
	REM anfang 35 - 289415 - S-974 / s979 Schildschwanz -ve
	if %%z equ 35 (
		REM goto :takeTime
		set proj_Num=289415aa
		set interval=1119 10 1199
