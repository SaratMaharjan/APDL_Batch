...
copy C:\\Users\\Asus\\AppData\\Local\\SpaceClaim\\CustomShortcuts.xml z:\\CustomShortcuts.xml^
 ...
 && copy C:\\Users\\Asus\\AppData\\Local\\SpaceClaim\\SpaceClaim.exe_Url_5xlzceexyksps5lultd1ap5hgp50t5bh\\1.0.0.0\\user.config z:\\spaceclain_user.config^
 && copy C:\\Users\\Asus\\AppData\\Local\\SpaceClaim\\SpaceClaim\\barlayout2.xml z:\\spaceclaim_barlayout2.xml^
 && copy C:\\Users\\Asus\\AppData\\Roaming\\Microsoft\\Templates\\Normal.dotm z:\\Normal.dotm^
 && npm list --global --depth=0 > z:\npm-list.txt^
 && type z:\npm-list.txt^
 && pip list > z:\pip-list.txt^
 && type z:\pip-list.txt
