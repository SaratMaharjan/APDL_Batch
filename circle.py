...
btn1 = Button(text='Calculate',  font=(
    'arial', 30, 'bold'), width=15, command=calculate).grid(row=2, column=1, sticky=W)
btn2 = Button(text='Clear',  font=('arial', 30, 'bold'),
              width=15, command=clear).grid(row=2, column=1, sticky=E)
